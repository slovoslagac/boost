            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr style="background:#f7fafc;">
                  <td>183</td>
                  <td style="text-align:center;" class="bg-olive" title="Solo Net Wins">SNW</td>
                  <td><b>John Doe</b></td>
                  <td>11.07.2017.</td>
                  <td>EUW</td>
                  <td>D5</td>
                  ...
                  <td>45€</td>
                  <td><b>27€</b></td>
                  <td><span class="label label-primary">Aktivno</span></td>
                </tr>
                <tr style="background:#fdebd0;">
                  <td>182</td>
                  <td style="text-align:center;" class="bg-navy" title="Duo Placement">DP</td>
                  <td><b>John Doe</b></td>
                  <td>11.07.2017.</td>
                  <td>EUW</td>
                  <td>D5</td>
                  ...
                  <td>45€</td>
                  <td><b>27€</b></td>
                  <td><span class="label label-warning">Na isplati</span></td>
                </tr>
                <tr style="background:#f8dbd7;">
                  <td>181</td>
                  <td style="text-align:center;" class="bg-blue" title="Solo Division">SD</td>
                  <td><b>John Doe</b></td>
                  <td>11.07.2017.</td>
                  <td>EUW</td>
                  <td>D5</td>
                  ...
                  <td>45€</td>
                  <td><b>27€</b></td>
                  <td><span class="label label-danger">Otkazano</span></td>
                </tr>
                <tr style="background:#def1de;">
                  <td>180</td>
                  <td style="text-align:center;" class="bg-olive" title="Solo Net Wins">SNW</td>
                  <td><b>John Doe</b></td>
                  <td>11.07.2017.</td>
                  ...
                  <td>45€</td>
                  <td><b>27€</b></td>
                  <td><span class="label label-success">Isplaćeno</span></td>
                </tr>
              </table>
            </div>
            <!-- /.box-body -->
